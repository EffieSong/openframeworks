...
void ofApp::setup(){
    ...
    soundPlayer1.load("happy.wav");
    soundPlayer2.load("sad.wav");
    soundPlayer3.load("surprise.wav");
    soundPlayer4.load("angry.wav");
...
ofPoint pos_mid(centerX+80, centerY-120);
ofPoint posa(centerX+46, centerY-180);
ofPoint posb(centerX+114, centerY-180);
ofPoint pos_top(centerX+80, centerY-180);
...
void ofApp::anger(){
    ...
    posmid.x = (1-pct) * pos_top.x + (pct) * pos_mid.x;
    posmid.y = (1-pct) * pos_top.y + (pct) * pos_mid.y;
    posleft.x = (1-pct) * pos_top.x + (pct) * posa.x;
     posleft.y = (1-pct) * pos_top.y + (pct) * posa.y;
    posright.x = (1-pct) * pos_top.x + (pct) * posb.x;
     posright.y = (1-pct) * pos_top.y + (pct) * posb.y;
    ...
    ofSetColor(100, 200, 100);
    ofFill();
   // ofDrawTriangle(centerX+80, centerY-180, centerX+12, centerY-60, centerX+148, centerY-60);
    ofBeginShape();
    ofVertex(centerX+12, centerY-60);//left
    ofVertex(posleft);//left top
    ofVertex(posmid);//mid
    ofVertex(posright);//right top
    ofVertex(centerX+148, centerY-60);//right
//    ofVertex(20,40);
    ofEndShape();
